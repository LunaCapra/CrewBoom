...
### [Plugin](https://github.com/SGiygas/BrcCustomCharacters/releases/download/v2.1.0/plugin.zip)
### [Unity project](https://github.com/SGiygas/BrcCustomCharacters/releases/download/v2.1.0/unityProject.zip)
