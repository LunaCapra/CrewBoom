...
### [Plugin](https://github.com/SGiygas/CrewBoom/releases/download/v3.2.5/plugin.zip)
### [Unity project](https://github.com/SGiygas/CrewBoom/releases/download/v3.2.5/unityProject.zip)
...
**Manual Install**
1. Download the [plugin](https://github.com/SGiygas/CrewBoom/releases/download/v3.2.5/plugin.zip)
