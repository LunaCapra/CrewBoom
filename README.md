...
### [Plugin](https://github.com/SGiygas/BrcCustomCharacters/releases/download/v2.2.1/plugin.zip)
### [Unity project](https://github.com/SGiygas/BrcCustomCharacters/releases/download/v2.2.1/unityProject.zip)
